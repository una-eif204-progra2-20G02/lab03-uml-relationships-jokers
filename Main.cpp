...
int main() {
    ...
    Medicamento *Panadol = new Medicamento("Panadol", 12.4, 5000, 90, 2030);
    Medicamento *Acetaminofen = new Medicamento("Acetaminofen", 5.2, 3000, 75, 2032);
    Medicamento *Vitaminas = new Medicamento("Vitaminas", 3.3, 1000, 50, 2023);
